...
type StopOrDeleteButtonProps = {
  readonly isComplete: boolean;
  readonly isSmallScreen: boolean;
  readonly isTinyScreen: boolean;
  readonly loaded: boolean;
  readonly removing: boolean;
  readonly stopOrRemove: () => void;
  readonly stopping: boolean;
  readonly working: boolean;
};

const StopOrDeleteButton: React.FC<StopOrDeleteButtonProps> = ({
  isComplete,
  isSmallScreen,
  isTinyScreen,
  loaded,
...
const SearchDetailHeader: React.FC<Props> = ({
  creating,
  disabled,
  loaded,
  loading,
